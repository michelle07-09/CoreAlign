        ...
        <div class="p-xl max-w-7xl w-full mx-auto space-y-lg">
            ...
            <div class="grid grid-cols-12 gap-lg">
                ...
                <section class="col-span-12 lg:col-span-8 space-y-lg">
                    ...
                    <div class="bg-surface-container-lowest border border-stone-200 rounded-[16px] p-lg">
                        <div class="flex items-center gap-md mb-lg"><span
                                class="material-symbols-outlined text-primary-container">lock_person</span>
                            <h4 class="font-headline-sm text-headline-sm">Branch Access &amp; Permissions</h4>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="w-full text-left border-collapse">
                                <thead class="border-b border-stone-200">
                                    <tr class="text-label-caps text-on-surface-variant">
                                        <th class="py-md font-semibold">Permission Type</th>
                                        <th class="py-md text-center">Front Desk</th>
                                        <th class="py-md text-center">Instructor</th>
                                        <th class="py-md text-center">Finance</th>
                                    </tr>
                                </thead>
                                <tbody class="text-body-sm">
                                    <tr class="border-b border-stone-100">
                                        <td class="py-md">View Revenue</td>
                                        <td class="py-md text-center"><input
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td class="py-md text-center"><input
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td class="py-md text-center"><input checked=""
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                    </tr>
                                    <tr class="border-b border-stone-100">
                                        <td class="py-md">Modify Schedule</td>
                                        <td class="py-md text-center"><input checked=""
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td class="py-md text-center"><input checked=""
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                    ...
                                    <tr class="border-b border-stone-100">
                                        <td class="py-md">Check-in Members</td>
                                        <td class="py-md text-center"><input checked=""
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td class="py-md text-center"><input checked=""
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                    ...
                                    <tr>
                                        <td class="py-md">Manage Staff</td>
                                        <td class="py-md text-center"><input
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td class="py-md text-center"><input
                                                class="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                        ...
                        <div class="mt-md pt-md border-t border-stone-100 flex justify-end">
                            <p class="text-[11px] text-stone-500 italic">Changes apply to the currently selected branch
                                context.</p>
                        </div>
                    </div>
                </section>
