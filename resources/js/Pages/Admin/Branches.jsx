        ...
        <div className="p-xl max-w-7xl w-full mx-auto space-y-lg">
            ...
            <div className="grid grid-cols-12 gap-lg">
                ...
                <section className="col-span-12 lg:col-span-8 space-y-lg">
                    ...
                    <div className="bg-surface-container-lowest border border-stone-200 rounded-[16px] p-lg">
                        <div className="flex items-center gap-md mb-lg"><span
                                className="material-symbols-outlined text-primary-container">lock_person</span>
                            <h4 className="font-headline-sm text-headline-sm">Branch Access &amp; Permissions</h4>
                        </div>
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead className="border-b border-stone-200">
                                    <tr className="text-label-caps text-on-surface-variant">
                                        <th className="py-md font-semibold">Permission Type</th>
                                        <th className="py-md text-center">Front Desk</th>
                                        <th className="py-md text-center">Instructor</th>
                                        <th className="py-md text-center">Finance</th>
                                    </tr>
                                </thead>
                                <tbody className="text-body-sm">
                                    <tr className="border-b border-stone-100">
                                        <td className="py-md">View Revenue</td>
                                        <td className="py-md text-center"><input
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td className="py-md text-center"><input
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td className="py-md text-center"><input checked=""
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                    </tr>
                                    <tr className="border-b border-stone-100">
                                        <td className="py-md">Modify Schedule</td>
                                        <td className="py-md text-center"><input checked=""
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td className="py-md text-center"><input checked=""
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                    ...
                                    <tr className="border-b border-stone-100">
                                        <td className="py-md">Check-in Members</td>
                                        <td className="py-md text-center"><input checked=""
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td className="py-md text-center"><input checked=""
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                    ...
                                    <tr>
                                        <td className="py-md">Manage Staff</td>
                                        <td className="py-md text-center"><input
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                                        <td className="py-md text-center"><input
                                                className="rounded text-primary focus:ring-primary" type="checkbox" /></td>
                        ...
                        <div className="mt-md pt-md border-t border-stone-100 flex justify-end">
                            <p className="text-[11px] text-stone-500 italic">Changes apply to the currently selected branch
                                context.</p>
                        </div>
                    </div>
                </section>
